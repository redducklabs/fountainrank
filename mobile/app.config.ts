...
// Version 1.0.4 was submitted to App Store Connect (TestFlight), so the next release floor is
// 1.0.5. The CI release (release-notes job) uses this as the version floor and passes it as
// EXPO_APP_VERSION.
const defaultAppVersion = "1.0.5";
