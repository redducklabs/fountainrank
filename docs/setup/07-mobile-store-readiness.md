...
| App icon / splash              | Generated from `docs/logos/512-pin.png` and committed under `mobile/assets/`; wired in `mobile/app.config.ts`.                                                                                                                                                                                      | Review in native build before store upload. |
...
| Play feature graphic             | `mobile/assets/store/play-feature-graphic.png`         | Copied from `docs/logos/feature-graphic.png`; review in Play Console before submission. |
